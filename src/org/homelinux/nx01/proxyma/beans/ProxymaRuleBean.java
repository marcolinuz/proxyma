...
public class ProxymaRuleBean {
    ...
    public void setProxyPassHost(String proxyPassHost) throws NullPointerException, IllegalArgumentException {
        ...
        if (proxyPassHost == null) {
            System.out.println("proxyPassHost needs a VALID URL.");
    ...
    /**
     * Obtain the status of the debugMode attribute for the rule.
     *
     * @return true or false
     */
    ...
    /**
     * Set the status of the debugMode attribute for the rule.
     *
     * @param debugModeEnabled this must be true or false.
     */
    ...
    //Debug mode for this destination
    private boolean debugModeEnabled = ProxymaConstants.DEFAULT_DEBUG_MODE_ENABLED;
