...
public class ProxymaConfigurationServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        //Set the System property for the path of the log files of the Proxyma library
        ...
        String loggingConfiguratioFile = this.getServletContext().getRealPath(ConfigurationConstants.loggingConfigurationFilePath + "/" + ProxymaConstants.log4jConfigurationFileName);
        System.setProperty(ProxymaConstants.log4jConfigurationFileProperty, loggingConfiguratioFile);

        //..and initialize the log4j subsystem.
