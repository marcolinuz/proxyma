...
public class ProxymaRuleSet {
    ...
    public boolean removeRule(ProxymaRuleBean rule) throws NullPointerException {
        ...
        if (theRealRuleSet.containsKey(rule.getProxyFolder())) {
            ...
            retValue = false;
            System.out.println("WARNING: Can't delete specified rule \"" + rule.getProxyFolder() + "\" because it does not exist.");
    ...
    public boolean addNewRule(ProxymaRuleBean rule)
        ...
        if (theRealRuleSet.containsKey(rule.getProxyFolder())) {
            retValue = false;
            System.out.println("WARNING: Can't add specified rule \"" + rule.getProxyFolder() + "\" because it already exists.");
            ...
            if (theRuleSetByProxedHost.containsKey(rule.getProxyPassHost())) {
                retValue = false;
                System.out.println("WARNING: Can't add specified rule \"" + rule.getProxyFolder() + "\" because there is another rule with the same Masqueraded Host as Target.");
                ...
                if (!(retValue)) {
                    System.out.println("WARNING: specified rule \"" + rule.toString() + "\" was not added.");
